describe("A Tap gesture directive", function () {
    ...
    it("should be executed and register " + tapType[0] + "Tap gesture event listener ", inject(function ($rootScope, $compile) {
        spyOn(_LeapController.prototype, "connect");
        spyOn(_LeapController.prototype, "on");

        var html = "<div leap-" + tapType[0] + "-tap='test=test+1'></div>";
    ...
    it("should be executed and register " + tapType[1] + "Tap gesture event listener ", inject(function ($rootScope, $compile) {
        spyOn(_LeapController.prototype, "connect");
        spyOn(_LeapController.prototype, "on");

        var html = "<div leap-" + tapType[1] + "-tap='test=test+1'></div>";
        var scope = $rootScope.$new();
        var element = $compile(html)(scope);
    ...
    it("should execute scope function", inject(function ($rootScope, $compile) {
        ...
        var html = "<div leap-" + tapType[0] + "-tap='testFunction()'></div>";
        var element = $compile(html)(scope);
    ...
    it("should use timeout if it configured", inject(function ($rootScope, $compile, $browser) {
        ...
        spyOn(_LeapController.prototype, "on");
        var scope = $rootScope.$new();
        var html = "<div leap-" + tapType[0] + "-tap='testFunction()' leap-timeout='1000'></div>";
        var element = $compile(html)(scope);
